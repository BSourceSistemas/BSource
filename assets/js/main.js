var Zepto = function() {
    ...
    return z.matches = function(t, e) {
        ...
        var i, r = t.parentNode,
            o = !r;
        return o && (r = F).appendChild(t), i = ~z.qsa(r, e).indexOf(t), o && F.removeChild(t), i
    }, L = function(t) {
        ...
        var i, r, o;
        return A.test(t) && (i = w(T.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(k, "<$1></$2>")), e === y && (e = P.test(t) && RegExp.$1), e in M || (e = "*"), (o = M[e]).innerHTML = "" + t, i = w.each(C.call(o.childNodes), function() {
            o.removeChild(this)
        })), u(n) && (r = w(i), w.each(n, function(t, e) {
            -1 < D.indexOf(t) ? r[t](e) : r.attr(t, e)
        })), i
    }, z.Z = function(t, e) {
        return (t = t || []).__proto__ = w.fn, t.selector = e || "", t
    }, z.isZ = function(t) {
        ...
        if (!t) return z.Z();
        if ("string" == typeof t)
            if ("<" == (t = t.trim())[0] && P.test(t)) n = z.fragment(t, RegExp.$1, e), t = null;
            else {
            ...
            if (z.isZ(t)) return t;
            if (J(t)) i = t, n = j.call(i, function(t) {
                return null != t
            });
            else if (r(t)) n = [t], t = null;
            else if (P.test(t)) n = z.fragment(t.trim(), RegExp.$1, e), t = null;
            else {
                if (e !== y) return w(e).find(t);
                n = z.qsa(T, t)
            }
    ...
    }, w.contains = T.documentElement.contains ? function(t, e) {
        return t !== e && t.contains(e)
    } : function(t, e) {
        for (; e && (e = e.parentNode);)
            if (e === t) return !0;
        return !1
    }, w.type = c, w.isFunction = s, w.isWindow = o, w.isArray = J, w.isPlainObject = u, w.isEmptyObject = function(t) {
        var e;
        for (e in t) return !1;
        return !0
    }, w.inArray = function(t, e, n) {
        return S.indexOf.call(e, t, n)
    }, w.camelCase = L, w.trim = function(t) {
        return null == t ? "" : String.prototype.trim.call(t)
    }, w.uuid = 0, w.support = {}, w.expr = {}, w.map = function(t, e) {
        var n, i, r, o, s = [];
        if (l(t))
        ...
        return j.call(t, e)
    }, window.JSON && (w.parseJSON = JSON.parse), w.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(t, e) {
        ...
        concat: S.concat,
        map: function(n) {
            return w(w.map(this, function(t, e) {
                return n.call(t, e, t)
            }))
        },
        slice: function() {
        ...
        ready: function(t) {
            return I.test(T.readyState) && T.body ? t(w) : T.addEventListener("DOMContentLoaded", function() {
                t(w)
            }, !1), this
        },
        get: function(t) {
        ...
        filter: function(e) {
            return s(e) ? this.not(this.not(e)) : w(j.call(this, function(t) {
        ...
        parents: function(t) {
            for (var e = [], n = this; 0 < n.length;) n = w.map(n, function(t) {
        ...
        siblings: function(t) {
            return d(this.map(function(t, e) {
                return j.call(i(e.parentNode), function(t) {
                    return t !== e
                })
            }), t)
        },
        ...
        show: function() {
            return this.each(function() {
                var t, e, n;
                "none" == this.style.display && (this.style.display = ""), "none" == getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = (t = this.nodeName, N[t] || (e = T.createElement(t), T.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), N[t] = n), N[t]))
            })
        },
        ...
        prop: function(e, n) {
            return e = $[e] || e, 1 in arguments ? this.each(function(t) {
        ...
        css: function(t, e) {
            ...
            if ("string" == c(t)) e || 0 === e ? o = f(t) + ":" + h(t, e) : this.each(function() {
                ...
                for (b in t) t[b] || 0 === t[b] ? o += f(b) + ":" + h(b, t[b]) + ";" : this.each(function() {
        ...
        addClass: function(n) {
            return n ? this.each(function(t) {
                if ("className" in this) {
                    ...
                    }, this), x.length && v(this, e + (e ? " " : "") + x.join(" "))
                }
            }) : this
        },
        removeClass: function(e) {
            return this.each(function(t) {
                if ("className" in this) {
                    ...
                    x = v(this), p(this, e, t, x).split(/\s+/g).forEach(function(t) {
                        x = x.replace(n(t), " ")
                    }), v(this, x.trim())
                }
            })
        ...
        toggleClass: function(n, i) {
            return n ? this.each(function(t) {
                var e = w(this);
                p(this, n, t, v(this)).split(/\s+/g).forEach(function(t) {
        ...
        position: function() {
            if (this.length) {
                ...
                return n.top -= parseFloat(w(t).css("margin-top")) || 0, n.left -= parseFloat(w(t).css("margin-left")) || 0, i.top += parseFloat(w(e[0]).css("border-top-width")) || 0, i.left += parseFloat(w(e[0]).css("border-left-width")) || 0, {
                    top: n.top - i.top,
                    left: n.left - i.left
                }
            }
    ...
    }, w.fn.detach = w.fn.remove, ["width", "height"].forEach(function(i) {
        var r = i.replace(/./, function(t) {
            return t[0].toUpperCase()
        });
        w.fn[i] = function(e) {
            var t, n = this[0];
            return e === y ? o(n) ? n["inner" + r] : a(n) ? n.documentElement["scroll" + r] : (t = this.offset()) && t[i] : this.each(function(t) {
                (n = w(this)).css(i, p(this, e, t, n[i]()))
            })
        }
    }), ["after", "prepend", "before", "append"].forEach(function(e, s) {
        var a = s % 2;
        w.fn[e] = function() {
            var e, i, r = w.map(arguments, function(t) {
                    return "object" == (e = c(t)) || "array" == e || null == t ? t : z.fragment(t)
                }),
                o = 1 < this.length;
            return r.length < 1 ? this : this.each(function(t, e) {
                i = a ? e : e.parentNode, e = 0 == s ? e.nextSibling : 1 == s ? e.firstChild : 2 == s ? e : null;
            ...
            return w(t)[e](this), this
        }
    }), z.Z.prototype = w.fn, z.uniq = E, z.deserializeValue = g, w.zepto = z, w
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    function(l) {
        ...
        function u(r, t, e, o, s, a, c) {
            ...
            t.split(/\s/).forEach(function(t) {
                ...
                var n = h(t);
                n.fn = e, n.sel = s, n.e in E && (e = function(t) {
                ...
                }, n.i = u.length, u.push(n), "addEventListener" in r && r.addEventListener(p(n.e), n.proxy, d(n, c))
            })
        }
        ...
        function m(e, t, n, i, r) {
            ...
            (t || "").split(/\s/).forEach(function(t) {
                s(e, t, n, i).forEach(function(t) {
                    delete L[o][t.i], "removeEventListener" in e && e.removeEventListener(p(t.e), t.proxy, d(t, r))
                })
            })
        }
        ...
        function v(i, r) {
            return (r || !i.isDefaultPrevented) && (r || (r = i), l.each(t, function(t, e) {
                var n = r[t];
                i[t] = function() {
                    return this[e] = a, n && n.apply(r, arguments)
                }, i[e] = S
            }), (r.defaultPrevented !== y ? r.defaultPrevented : "returnValue" in r ? !1 === r.returnValue : r.getPreventDefault && r.getPreventDefault()) && (i.isDefaultPrevented = a)), i
        }
        ...
        l.fn.delegate = function(t, e, n) {
            ...
            var a, c, i = this;
            return e && !x(e) ? (l.each(e, function(t, e) {
                i.on(t, r, n, e, s)
            ...
            var i = this;
            return t && !x(t) ? (l.each(t, function(t, e) {
                i.off(t, n, e)
            }), i) : (x(n) || w(e) || !1 === e || (e = n, n = y), !1 === e && (e = S), i.each(function() {
                m(this, t, e, n)
            }))
        }, l.fn.trigger = function(t, e) {
            return (t = x(t) || l.isPlainObject(t) ? l.Event(t) : v(t))._args = e, this.each(function() {
            ...
            return this.each(function(t, e) {
                (r = g(x(n) ? l.Event(n) : n))._args = i, r.target = e, l.each(s(e, n.type || n), function(t, e) {
    ...
    function(dh) {
        ...
        Ch.href = window.location.href, dh.active = 0, dh.ajaxJSONP = function(n, i) {
            ...
            return i && i.promise(u), dh(a).on("load error", function(t, e) {
                clearTimeout(o), dh(a).off().remove(), "error" != t.type && r ? jh(r[0], u, n, i) : kh(null, e || "error", u, n, i), window[s] = c, r && dh.isFunction(c) && c(r[0]), c = r = void 0
            ...
            var i, r = this,
                ...
                s = qh(t, e, n),
                a = s.success;
            return 1 < o.length && (s.url = o[0], i = o[1]), s.success = function(t) {
                r.html(i ? dh("<div>").html(t.replace(wh, "")).find(i) : t), a && a.apply(r, arguments)
            }, dh.ajax(s), this
        };
            ...
            return n.add = function(t, e) {
                ...
                function n(i, t, r, o) {
                    ...
                    dh.each(t, function(t, e) {
                        s = dh.type(e), o && (t = r ? o : o + "[" + (c || "object" == s || "array" == s ? t : "") + "]"), !o && a ? i.add(e.name, e.value) : "array" == s || !r && "object" == s ? n(i, e, r, t) : i.add(t, e)
                    })
            ...
            document.addEventListener("scroll", function() {
                ...
                if (h.style.bottom = d < t ? "0%" : "-100%", t <= p) {
                    var e = t / p,
                        n = (100 * e).toFixed(2),
                        i = 100 - parseFloat(n);
                    m.style.width = n.toString() + "%", v.style.width = i.toString() + "%";
                    ...
                    s = s < 10 ? "0" + s : s, a = a < 10 ? "0" + a : a, u = u < 10 ? "0" + u : u, l = l < 10 ? "0" + l : l, g.innerText = s + ":" + a, y.innerText = u + ":" + l
                } else {
                    m.style.width = "100%", v.style.width = "0%";
                    var f = parseInt(h.getAttribute("data-minutes"));
                    f = f < 10 ? "0" + f : f, g.innerText = "00:00", y.innerText = f + ":00"
                }
                d = t
            })
        }
    ...
    function(i) {
        ...
        function r(t, e) {
            var n = t.offsetHeight,
                ...
                r = i + s(),
                o = function(t) {
                    for (var e = 0, n = 0; isNaN(t.offsetTop) || (e += t.offsetTop), isNaN(t.offsetLeft) || (n += t.offsetLeft), t = t.offsetParent;);
                    return {
                        top: e,
                        left: n
                    }
        ...
        t.prototype = {
            ...
            _init: function() {
                ...
                n.items.forEach(function(t, e) {
                    ...
                    n._onScrollFn()
                }, !1), i.addEventListener("resize", function() {
                    n._resizeHandler()
                }, !1)
            },
                ...
                this.items.forEach(function(n, t) {
                    classie.has(n, "shown") || classie.has(n, "animate") || !r(n, i.options.viewportFactor) || setTimeout(function() {
                        ...
                        if (i.el.style.WebkitPerspectiveOrigin = "50% " + t + "px", i.el.style.MozPerspectiveOrigin = "50% " + t + "px", i.el.style.perspectiveOrigin = "50% " + t + "px", i._checkTotalRendered(), i.options.minDuration && i.options.maxDuration) {
                            ...
                            n.style.WebkitAnimationDuration = e, n.style.MozAnimationDuration = e, n.style.animationDuration = e
                        }
                        classie.add(n, "animate"), o(n.querySelector(".preload"))
                    }, 25)
                }), this.didScroll = !1
            },
            ...
            _checkTotalRendered: function() {
                ++this.itemsRenderedCount, this.itemsRenderedCount === this.itemsCount && i.removeEventListener("scroll", this._onScrollFn)
            }
        }, i.AnimOnScroll = t
    }(window),
    function(u) {
        u.fn.simpleJekyllSearch = function(t) {
            ...
            r.jsonFile.length && a.length && u.ajax({
                ...
                success: function(t, e, n) {
                    s = t, i.keyup(function(t) {
                        var e, n, i;
                        u(this).val().length ? (n = u(this).val(), i = [], u.each(s, function(t, e) {
                            for (t = 0; t < o.length; t++) void 0 !== e[o[t]] && -1 !== e[o[t]].toLowerCase().indexOf(n.toLowerCase()) && (i.push(e), t = o.length)
                        }), e = i, c(), a.append(u(r.searchResultsTitle)), e.length ? u.each(e, function(t, e) {
                            if (t < r.limit) {
                                for (var n = r.template, t = 0; t < o.length; t++) {
    ...
    function(t, e) {
        ...
        i.animateScroll = function(a, c, t) {
            var e, n = (e = a ? a.getAttribute("data-options") : null) && "object" == typeof JSON && "function" == typeof JSON.parse ? JSON.parse(e) : {},
                ...
                f = b.pageYOffset;
            s || (s = b.document.querySelector(u.selectorHeader)), w || (w = E(s));
            var h, d, p, i, r, m = function(t, e, n) {
                ...
                y = 0;
            i = c, r = u.updateURL, b.history.pushState && (r || "true" === r) && "file:" !== b.location.protocol && b.history.pushState(null, null, [b.location.protocol, "//", b.location.host, b.location.pathname, b.location.search, i].join(""));
            var o = function() {
                var t, e, n, i, r, o, s;
                d = 1 < (d = (y += 16) / parseInt(u.speed, 10)) ? 1 : d, p = f + v * (t = u.easing, e = d, "easeInQuad" === t && (n = e * e), "easeOutQuad" === t && (n = e * (2 - e)), "easeInOutQuad" === t && (n = e < .5 ? 2 * e * e : (4 - 2 * e) * e - 1), "easeInCubic" === t && (n = e * e * e), "easeOutCubic" === t && (n = --e * e * e + 1), "easeInOutCubic" === t && (n = e < .5 ? 4 * e * e * e : (e - 1) * (2 * e - 2) * (2 * e - 2) + 1), "easeInQuart" === t && (n = e * e * e * e), "easeOutQuart" === t && (n = 1 - --e * e * e * e), "easeInOutQuart" === t && (n = e < .5 ? 8 * e * e * e * e : 1 - 8 * --e * e * e * e), "easeInQuint" === t && (n = e * e * e * e * e), "easeOutQuint" === t && (n = 1 + --e * e * e * e * e), "easeInOutQuint" === t && (n = e < .5 ? 16 * e * e * e * e * e : 1 + 16 * --e * e * e * e * e), n || e), b.scrollTo(0, Math.floor(p)), i = p, r = m, o = h, s = b.pageYOffset, (i == r || s == r || b.innerHeight + s >= g) && (clearInterval(o), l.focus(), u.callback(a, c))
            };
            0 === b.pageYOffset && b.scrollTo(0, 0), h = setInterval(o, 16)
        };
        var o = function(t) {
                var e = function(t, e) {
    ...
    function(e, t, n) {
        e("#menu").click(function() {
            e("body").addClass("push-menu-to-right"), e("#sidebar").addClass("open"), e(".overlay").addClass("show")
        }), e("#mask").click(function() {
            e("body").removeClass("push-menu-to-right"), e("#sidebar").removeClass("open"), e(".overlay").removeClass("show")
        });
        var i = {
        ...
        function r() {
            e(".search-wrapper").toggleClass("active"), i.searchform.toggleClass("active"), i.canvas.removeClass("search-overlay")
        }
        i.dothis.on("click", function() {
            e(".search-wrapper").toggleClass("active"), i.searchform.toggleClass("active"), i.searchform.find("input").focus(), i.canvas.toggleClass("search-overlay"), e(".search-field").simpleJekyllSearch()
        }), i.close.on("click", r), document.addEventListener("keyup", function(t) {
...
var Zepto = function() {
    ...
    return Y.matches = function(t, e) {
        ...
        var r, i, s;
        return D.test(t) && (r = S(P.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(H, "<$1></$2>")), e === x && (e = _.test(t) && RegExp.$1), e in q || (e = "*"), s = q[e], s.innerHTML = "" + t, r = S.each(N.call(s.childNodes), function() {
            s.removeChild(this)
        ...
        if (!t) return Y.Z();
        if ("string" == typeof t)
            if (t = t.trim(), "<" == t[0] && _.test(t)) r = Y.fragment(t, RegExp.$1, n), t = null;
            else {
            ...
            else if (_.test(t)) r = Y.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== x) return S(n).find(t);
                r = Y.qsa(P, t)
            }
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || P.body; t && !z.test(t.nodeName) && "static" == S(t).css("position");) t = t.offsetParent;
                return t
            })
        }
        ...
        S.fn[t] = function(i) {
            ...
            return i === x ? n(s) ? s["inner" + e] : r(s) ? s.documentElement["scroll" + e] : (o = this.offset()) && o[t] : this.each(function(e) {
                s = S(this), s.css(t, v(this, i, e, s[t]()))
            })
        }
    ...
    }), Y.Z.prototype = S.fn, Y.uniq = T, Y.deserializeValue = b, S.zepto = Y, S
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    function(t) {
        function e(t) {
    ...
    function(t) {
        ...
        j.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            if (c && c.promise(S), i.crossDomain || x("X-Requested-With", "XMLHttpRequest"), x("Accept", b || "*/*"), (b = i.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(b)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && x("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)
    ...
    function(t) {
        ...
        function n() {
            return t.pageYOffset || a.scrollTop
        }
        ...
        s.prototype = {
            ...
            _init: function() {
                ...
                e.items.forEach(function(t, n) {
                    i(t) && (e._checkTotalRendered(), classie.add(t, "shown"))
            ...
            _resizeHandler: function() {
                ...
                var e = this;
                this.resizeTimeout && clearTimeout(this.resizeTimeout), this.resizeTimeout = setTimeout(t, 1e3)
            },
            _checkTotalRendered: function() {
                ++this.itemsRenderedCount, this.itemsRenderedCount === this.itemsCount && t.removeEventListener("scroll", this._onScrollFn)
            }
        }, t.AnimOnScroll = s
    }(window),
    function(t) {
        t.fn.simpleJekyllSearch = function(e) {
            ...
            function r(e) {
                ...
                return t.each(c, function(t, r) {
                    for (var t = 0; t < a.length; t++) void 0 !== r[a[t]] && r[a[t]].toLowerCase().indexOf(e.toLowerCase()) !== -1 && (n.push(r), t = a.length)
                }), n
            }
    ...
    function(t, e) {
        ...
        var e, n, r, i, o = {},
            ...
            l = function(t, e) {
                var n, r, i = e.charAt(0),
                    o = "classList" in document.documentElement;
                for ("[" === i && (e = e.substr(1, e.length - 2), n = e.split("="), n.length > 1 && (r = !0, n[1] = n[1].replace(/"/g, "").replace(/'/g, ""))); t && t !== document; t = t.parentNode) {
                    if ("." === i)
                        if (o) {
                            if (t.classList.contains(e.substr(1))) return t
                        } else if (new RegExp("(^|\\s)" + e.substr(1) + "(\\s|$)").test(t.className)) return t;
            ...
            f = function(t) {
                for (var e, n = String(t), r = n.length, i = -1, o = "", s = n.charCodeAt(0); ++i < r;) {
                    ...
                    o += e >= 1 && e <= 31 || 127 == e || 0 === i && e >= 48 && e <= 57 || 1 === i && e >= 48 && e <= 57 && 45 === s ? "\\" + e.toString(16) + " " : e >= 128 || 45 === e || 95 === e || e >= 48 && e <= 57 || e >= 65 && e <= 90 || e >= 97 && e <= 122 ? n.charAt(i) : "\\" + n.charAt(i)
                }
                return o
            },
            h = function(t, e) {
        ...
        o.animateScroll = function(e, n, o) {
            ...
            var T = function(r, i, o) {
                ...
                O = function() {
                    j += 16, w = j / parseInt(u.speed, 10), w = w > 1 ? 1 : w, x = y + S * h(u.easing, w), t.scrollTo(0, Math.floor(x)), T(x, E, b)
                },
                N = function() {
                    b = setInterval(O, 16)
                };
    ...
    function() {
        for (var t = document.links, e = 0, n = t.length; e < n; e++) t[e].hostname != window.location.hostname && (t[e].target = "_blank", t[e].className += " externalLink")
    }(),
    function(t, e, n) {
        function r() {
            t(".search-wrapper").toggleClass("active"), o.searchform.toggleClass("active"), o.canvas.removeClass("search-overlay")
        }
        ...
        o.dothis.on("click", function() {
            t(".search-wrapper").toggleClass("active"), o.searchform.toggleClass("active"), o.searchform.find("input").focus(), o.canvas.toggleClass("search-overlay"), t(".search-field").simpleJekyllSearch()
        }), o.close.on("click", r), document.addEventListener("keyup", function(e) {
