...
! function () {
    ...
    var e, t = document.querySelector(".recommendation"),
        n = !1;
    t && (t.querySelector(".message > a").addEventListener("click", function () {
        return o(), !1
...
! function (o, e, a) {
    ...
    function r() {
        o(".search-wrapper").toggleClass("active"), n.searchform.toggleClass("active"), n.canvas.removeClass("search-overlay")
    }
    n.dothis.on("click", function () {
        o(".search-wrapper").toggleClass("active"), n.searchform.toggleClass("active"), n.searchform.find("input").focus(), n.canvas.toggleClass("search-overlay"), o(".search-field").simpleJekyllSearch()
    }), n.close.on("click", r), document.addEventListener("keyup", function (e) {
        27 == e.keyCode && o(".search-overlay").length && r()
