...
Ele permite que você criar as melhores aplicações multiplataformas usando nada além de um Browser, e tem uma API fenomenal. veja um exemplo geral de seus componentes.

<iframe height="457" style="width: 100%;" scrolling="no" title="extjs material design" src="//codepen.io/jesseRules/embed/raGgvW/?height=457&theme-id=0&default-tab=js,result" frameborder="no" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href='https://codepen.io/jesseRules/pen/raGgvW/'>extjs material design</a> by Jesse Carlberg
  (<a href='https://codepen.io/jesseRules'>@jesseRules</a>) on <a href='https://codepen.io'>CodePen</a>.
</iframe>
